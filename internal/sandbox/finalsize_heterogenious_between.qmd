---
title: "How to simulate the final size accounting for heterogeneous susceptibility between age groups only?"
format: 
  html:
    code-link: true
editor: source
...
- Different susceptibility to the infection between individuals of different age groups, from 20% (infants) to 100% (65+).
