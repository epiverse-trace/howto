---
title: "How to estimate the fraction of cases that are observed (ascertainment) using EpiNow2"
author:
  - name: "James M. Azam"
...
df <- as.data.table(df)[, primary := confirm]
...
df <- convolve_and_scale(df, type = "incidence")
#
