...
- Data frame with the number of primary and secondary observations per day.
- A prior of the ascertainment rate of the secondary observations from the primary ones.
...
- [Explanation on Estimate a Secondary Observation from a Primary Observation](https://epiforecasts.io/EpiNow2/reference/estimate_secondary.html)
- [Explanation on Estimating the proportion of cases that are ascertained during an outbreak using {cfr}](https://epiverse-trace.github.io/cfr/articles/estimate_ascertainment.html)
