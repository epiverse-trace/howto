---
title: "How to simulate the final size accounting for homogeneous susceptibility in all age groups?"
format: 
  html:
    code-link: true
editor: source
...
- Equal susceptibility to the infection across age groups.
...
- [Explanation on social contacts](https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.0050074)
