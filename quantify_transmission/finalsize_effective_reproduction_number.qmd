---
title: "How to simulate the effective reproductive number (R~eff~) accounting for heterogeneous social contact?"
format: 
  html:
    code-link: true
editor: source
...
- Account for homogeneous susceptibility in all age groups
